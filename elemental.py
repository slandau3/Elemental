...
def help():
    print("elemental [command] [associated input]\n"
          "Command      Info\n"
          "mass         Given an element, prints the mass of the element\n"
          "name         Given the mass, prints a name of the element\n"
          "symbol       Given an element, prints the name of the element\n"
          "compound     Given a compound, prints the mass of the compound\n"
          "info         Given an element, prints useful information about the element\n"
          "anum         Given an element, prints the atomic number of the element\n"
          "moles        Given the mass of an element then the elemental symbol, "
          "prints the number of moles of the given element that can be created\n"
          "limiting     Given the mass, element and compound, prints the number of moles of the"
          "compound that can be produced with the mass of the given element\n"
          "eq           Given an equation, prints the balanced form of the equation\n")
